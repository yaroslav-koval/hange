...
func (_mock *MockEncryptor) Encrypt(value []byte) ([]byte, error) {
...
//   - value []byte
func (_e *MockEncryptor_Expecter) Encrypt(value interface{}) *MockEncryptor_Encrypt_Call {
	return &MockEncryptor_Encrypt_Call{Call: _e.mock.On("Encrypt", value)}
}

func (_c *MockEncryptor_Encrypt_Call) Run(run func(value []byte)) *MockEncryptor_Encrypt_Call {
...
func (_c *MockEncryptor_Encrypt_Call) RunAndReturn(run func(value []byte) ([]byte, error)) *MockEncryptor_Encrypt_Call {
	_c.Call.Return(run)
	return _c
}
